...
public class CardProductAdd {

    private String userCode;
    private String nameCardProduct;
    private BigDecimal expireCardProduct;
    private String binCardProduct;
    private String cardTypeCardProduct;
    private String currencyCardProduct;
    private BigDecimal minBalanceResidentCardProduct;
    private BigDecimal minBalanceNoResidentCardProduct;
    private BigDecimal preNominalCardProduct;
    ...
    private String packageIdProduct;
    ...
    public String getCardTypeCardProduct() {
        return cardTypeCardProduct;
    }

    public void setCardTypeCardProduct(String cardTypeCardProduct) {
        this.cardTypeCardProduct = cardTypeCardProduct;
    }

    public String getCurrencyCardProduct() {
        return currencyCardProduct;
    }

    public void setCurrencyCardProduct(String currencyCardProduct) {
        this.currencyCardProduct = currencyCardProduct;
    }

    public BigDecimal getMinBalanceResidentCardProduct() {
        return minBalanceResidentCardProduct;
    }

    public void setMinBalanceResidentCardProduct(BigDecimal minBalanceResidentCardProduct) {
        this.minBalanceResidentCardProduct = minBalanceResidentCardProduct;
    }

    public BigDecimal getMinBalanceNoResidentCardProduct() {
        return minBalanceNoResidentCardProduct;
    }

    public void setMinBalanceNoResidentCardProduct(BigDecimal minBalanceNoResidentCardProduct) {
        this.minBalanceNoResidentCardProduct = minBalanceNoResidentCardProduct;
    }

    public BigDecimal getPreNominalCardProduct() {
        return preNominalCardProduct;
    }

    public void setPreNominalCardProduct(BigDecimal preNominalCardProduct) {
        this.preNominalCardProduct = preNominalCardProduct;
    }
    ...
    public String getPackageIdProduct() {
        return packageIdProduct;
    }

    public void setPackageIdProduct(String packageIdProduct) {
        this.packageIdProduct = packageIdProduct;
    }
    ...
    public String toString() {
        return "CardProductAdd{" +
                ...
                ", cardTypeCardProduct='" + cardTypeCardProduct + '\'' +
                ", currencyCardProduct='" + currencyCardProduct + '\'' +
                ", minBalanceResidentCardProduct=" + minBalanceResidentCardProduct +
                ", minBalanceNoResidentCardProduct=" + minBalanceNoResidentCardProduct +
                ", preNominalCardProduct=" + preNominalCardProduct +
                ...
                ", packageIdProduct='" + packageIdProduct + '\'' +
                '}';
    }
    ...
    public static final class Builder {
        ...
        public static Builder aCardProductAdd() { return new Builder(); }
        ...
        public Builder cardTypeCardProduct(String cardTypeCardProduct) {
            this.cardTypeCardProduct = cardTypeCardProduct;
            return this;
        }

        public Builder currencyCardProduct(String currencyCardProduct) {
            this.currencyCardProduct = currencyCardProduct;
            return this;
        }

        public Builder minBalanceResidentCardProduct(BigDecimal minBalanceResidentCardProduct) {
            this.minBalanceResidentCardProduct = minBalanceResidentCardProduct;
            return this;
        }

        public Builder minBalanceNoResidentCardProduct(BigDecimal minBalanceNoResidentCardProduct) {
            this.minBalanceNoResidentCardProduct = minBalanceNoResidentCardProduct;
            return this;
        }

        public Builder preNominalCardProduct(BigDecimal preNominalCardProduct) {
            this.preNominalCardProduct = preNominalCardProduct;
            return this;
        }
        ...
        public Builder packageIdProduct(String packageIdProduct) {
            this.packageIdProduct = packageIdProduct;
            return this;
        }

        public CardProductAdd build() {
            CardProductAdd cardProductAdd = new CardProductAdd();
            cardProductAdd.setUserCode(userCode);
            cardProductAdd.setNameCardProduct(nameCardProduct);
            cardProductAdd.setExpireCardProduct(expireCardProduct);
            cardProductAdd.setBinCardProduct(binCardProduct);
            cardProductAdd.setCardTypeCardProduct(cardTypeCardProduct);
            cardProductAdd.setCurrencyCardProduct(currencyCardProduct);
            cardProductAdd.setMinBalanceResidentCardProduct(minBalanceResidentCardProduct);
            cardProductAdd.setMinBalanceNoResidentCardProduct(minBalanceNoResidentCardProduct);
            cardProductAdd.setPreNominalCardProduct(preNominalCardProduct);
            cardProductAdd.setCodeCardTypeCardProduct(codeCardTypeCardProduct);
            cardProductAdd.setNameLangCardProduct(nameLangCardProduct);
            cardProductAdd.setCardNameCardProduct(cardNameCardProduct);
            cardProductAdd.setUrlCardProduct(urlCardProduct);
            cardProductAdd.setIsicCardProduct(isicCardProduct);
            cardProductAdd.setOnlineOrderCardProduct(onlineOrderCardProduct);
            cardProductAdd.setComissionCardProduct(comissionCardProduct);
            cardProductAdd.setMainCardProduct(mainCardProduct);
            cardProductAdd.setVirtualOperationCardProduct(virtualOperationCardProduct);
            cardProductAdd.setBanProlongCardProduct(banProlongCardProduct);
            cardProductAdd.setBanReemisionCardProduct(banReemisionCardProduct);
            cardProductAdd.setAdditionalCardProduct(additionalCardProduct);
            cardProductAdd.setCashbackCardProduct(cashbackCardProduct);
            cardProductAdd.setDispatchPinCardProduct(dispatchPinCardProduct);
            cardProductAdd.setAnalysisNonCashTurnoverCardProduct(analysisNonCashTurnoverCardProduct);
            cardProductAdd.setMegatransactorCardProduct(megatransactorCardProduct);
            cardProductAdd.setBanGiveMoneyCardProduct(banGiveMoneyCardProduct);
            cardProductAdd.setDoNotIncludeDocumentsCardProduct(doNotIncludeDocumentsCardProduct);
            cardProductAdd.setNotChangeCardAtTheCardPackageInIBCardProduct(notChangeCardAtTheCardPackageInIBCardProduct);
            cardProductAdd.setManyFunctionalCardsCardProduct(manyFunctionalCardsCardProduct);
            cardProductAdd.setCustomDesignCardProduct(customDesignCardProduct);
            cardProductAdd.setCustomDeliveryCardProduct(customDeliveryCardProduct);
            cardProductAdd.setCancelCompareVspomCardProduct(cancelCompareVspomCardProduct);
            cardProductAdd.setSaveCardNameVspomCardProduct(saveCardNameVspomCardProduct);
            cardProductAdd.setBanOperationInternetCardProduct(banOperationInternetCardProduct);
            cardProductAdd.setFreeVeiwBalanceCardProduct(freeVeiwBalanceCardProduct);
            cardProductAdd.setAllowComissionCardProduct(allowComissionCardProduct);
            cardProductAdd.setDesignIdEmvCardProduct(designIdEmvCardProduct);
            cardProductAdd.setApplIdEmvCardProduct(applIdEmvCardProduct);
            cardProductAdd.setVirtualCardProduct(virtualCardProduct);
            cardProductAdd.setAvtomaticEmissionCardProduct(avtomaticEmissionCardProduct);
            cardProductAdd.setDboCardProduct(dboCardProduct);
            cardProductAdd.setMinCountCardProduct(minCountCardProduct);
            cardProductAdd.setCountForGenerationCardProduct(countForGenerationCardProduct);
            cardProductAdd.setAllowSetLimitCardProduct(allowSetLimitCardProduct);
            cardProductAdd.setSumSetLimitBrisCardProduct(sumSetLimitBrisCardProduct);
            cardProductAdd.setSumSetLimitIbCardProduct(sumSetLimitIbCardProduct);
            cardProductAdd.setEditCardNameCardProduct(editCardNameCardProduct);
            cardProductAdd.setLenCardNameCardProduct(lenCardNameCardProduct);
            cardProductAdd.setAllowProlongIbCardProduct(allowProlongIbCardProduct);
            cardProductAdd.setAllowReemissionCardProduct(allowReemissionCardProduct);
            cardProductAdd.setMediaView1934CardProduct(mediaView1934CardProduct);
            cardProductAdd.setCardView1934CardProduct(cardView1934CardProduct);
            cardProductAdd.setSocialPurpose1934CardProduct(socialPurpose1934CardProduct);
            cardProductAdd.setDopServicesCardProduct(dopServicesCardProduct);
            cardProductAdd.setKobrendovayaCardProduct(kobrendovayaCardProduct);
            cardProductAdd.setContactlessCardProduct(contactlessCardProduct);
            cardProductAdd.setOptionsCardProduct(optionsCardProduct);
            cardProductAdd.setAvtomaticReplaceRateCardProduct(avtomaticReplaceRateCardProduct);
            cardProductAdd.setRateValueCardProduct(rateValueCardProduct);
            cardProductAdd.setTransferDepositRateCardProduct(transferDepositRateCardProduct);
            cardProductAdd.setDisableAdditionalPaymentsCardProduct(disableAdditionalPaymentsCardProduct);
            cardProductAdd.setNoActiveDepositCardProduct(noActiveDepositCardProduct);
            cardProductAdd.setDepositOrCreditCardProduct(depositOrCreditCardProduct);
            cardProductAdd.setTransferCreditRateWhenProlongCardProduct(transferCreditRateWhenProlongCardProduct);
            cardProductAdd.setTransferCreditRateWhenLimitChangedCardProduct(transferCreditRateWhenLimitChangedCardProduct);
            cardProductAdd.setTransferCreditRateWhenReplaceCardProduct(transferCreditRateWhenReplaceCardProduct);
            cardProductAdd.setDopProductForCardProduct(dopProductForCardProduct);
            cardProductAdd.setCurrencyProductForCardProduct(currencyProductForCardProduct);
            cardProductAdd.setFineCardProduct(fineCardProduct);
            cardProductAdd.setReplaceProductForProlongCardProduct(replaceProductForProlongCardProduct);
            cardProductAdd.setReplaceProductForReemisionCardProduct(replaceProductForReemisionCardProduct);
            cardProductAdd.setHandReplaceProductCardProduct(handReplaceProductCardProduct);
            cardProductAdd.setMinSumNonCashTurnoverCardProduct(minSumNonCashTurnoverCardProduct);
            cardProductAdd.setCardServiceDiscountCardProduct(cardServiceDiscountCardProduct);
            cardProductAdd.setSmsTariffCardProduct(smsTariffCardProduct);
            cardProductAdd.setUvkvCardProduct(uvkvCardProduct);
            cardProductAdd.setGroupRiskCardProduct(groupRiskCardProduct);
            cardProductAdd.setMegatransactorOptionsCardProduct(megatransactorOptionsCardProduct);
            cardProductAdd.setEnterpriseCardProduct(enterpriseCardProduct);
            cardProductAdd.setPackageIdProduct(packageIdProduct);
            cardProductAdd.isFreeCardProduct = this.isFreeCardProduct;
            return cardProductAdd;
        }
