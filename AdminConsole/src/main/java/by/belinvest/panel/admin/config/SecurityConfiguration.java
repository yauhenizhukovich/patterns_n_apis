...
import by.belinvest.panel.admin.service.impl.PreAuthorizationUserDetailsService;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    AuthenticationUserDetailsService<org.springframework.security.web.authentication.preauth.PreAuthenticatedAuthenticationToken> getUserDetailsService;
    ...
    public AuthenticationManager authenticationManager() {
        return new ProviderManager(Collections.singletonList(this.preAuthenticationProvider));
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.addFilterAfter(preAuthFilter(), AbstractPreAuthenticatedProcessingFilter.class)
                ...
                .and()
                .authorizeRequests().antMatchers("/belinvest/admin/**").permitAll();
        http.csrf().disable();
    }
