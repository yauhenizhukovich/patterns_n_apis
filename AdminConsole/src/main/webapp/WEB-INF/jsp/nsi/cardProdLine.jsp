...
<html>
<head>
    <title>Справочник линеек карточных продуктов (для бизнес-направления = Розничный)</title>
    <meta charset="UTF-8">
...
<div id="page-content">
    <div class="row justify-content-center page-title">
        <p class="display-4">Справочник линеек карточных продуктов (для бизнес-направления = Розничный)</p>
    </div>
