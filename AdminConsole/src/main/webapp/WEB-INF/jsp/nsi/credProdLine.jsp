...
<html>
<head>
    <title>Справочник линеек кредитных продуктов (для бизнес-направления = Корпоративный)</title>
    <meta charset="UTF-8">
...
<div id="page-content">
    <div class="row justify-content-center page-title">
        <p class="display-4">Справочник линеек кредитных продуктов (для бизнес-направления = Корпоративный)</p>
    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input name="NAME" min="1" class="form-control" id="input-nsi-NAME-create"
