...
<html>
<head>
    <title>Бизнес направление</title>
    <meta charset="UTF-8">
...
<div id="page-content">
    <div class="row justify-content-center page-title">
        <p class="display-4">Бизнес направление</p>
    </div>
    ...
    <table id="vid-table" class="table table-bordered">
        <thead>
        <tr>
            <th scope="col" style="text-align: center"> Бизнес-направление</th>
        </tr>
        </thead>
        <tbody id="vid">
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                <div class="buttons-for-product-manipulation"  >
                                    ...
                                    <button type="button" id="add_product_view_button" class="btn create-user-submit-button"
