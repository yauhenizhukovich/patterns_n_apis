...
<div id="page-content">
    <div class="row justify-content-center page-title">
        <p class="display-4">Вид продукта</p>
    </div>
    ...
    <table id="vid-table" class="table table-bordered">
        ...
        <tr>
            ...
            <th scope="col">Название вида продукта</th>
        </tr>
        </thead>
        <tbody id="vid">
    ...
    <div class="vid-page-buttons float-right">
        ...
        <button type="button" class="btn xxx" id="" disabled onclick="viewDelete()">Удалить</button>
    </div>
