    ...
    <c:forEach items="${directoryDTO.directory}" var="user">
        <tr>
            <td class="info" hidden>
                ...
                <span data-nsi class="CARD_OPT_ELEMENT">${user.cardOptElement}</span>
                <span data-nsi class="CARD_OPT_SEARCH">${user.cardOptSearch}</span>
            </td>
            <td class="DIMID">${user.dimid}</td>
            <td class="CODE">${user.code}</td>
            <td class="NAME">${user.name}</td>
            <td class="CARD_OPT_ELEMENT">${user.cardOptElement}</td>
            <td class="CARD_OPT_SEARCH">${user.cardOptSearch}</td>
