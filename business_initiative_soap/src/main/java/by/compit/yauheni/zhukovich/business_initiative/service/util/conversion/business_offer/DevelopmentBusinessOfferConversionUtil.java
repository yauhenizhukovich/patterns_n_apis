...
public class DevelopmentBusinessOfferConversionUtil {

    public static DevelopmentBusinessOffer convertDTOToDatabaseObject(TBIOnDevelopment onDevelopmentDTO) {
        DevelopmentBusinessOffer onDevelopment = new DevelopmentBusinessOffer();
    ...
    public static TBIOnDevelopment convertDatabaseObjectToDTO(DevelopmentBusinessOffer development) {
