...
public class DevelopmentBusinessInitiativeConversionUtil {

    public static DevelopmentBusinessInitiative convertDTOToDatabaseObject(TBIOnDevelopment onDevelopmentDTO) {
        DevelopmentBusinessInitiative onDevelopment = new DevelopmentBusinessInitiative();
    ...
    public static TBIOnDevelopment convertDatabaseObjectToDTO(DevelopmentBusinessInitiative development) {
