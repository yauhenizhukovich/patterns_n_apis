...
public class DevelopmentPARConversionUtil {

    public static DevelopmentPAR convertDTOToDatabaseObject(TBIOnDevelopment onDevelopmentDTO) {
        DevelopmentPAR onDevelopment = new DevelopmentPAR();
        ...
        XMLGregorianCalendar dateTo = onDevelopmentDTO.getDLGDateTo();
        if (dateTo != null) {
            onDevelopment.setDateTo(convertCalendarToLocalDate(dateTo));
        }
        XMLGregorianCalendar dateNom = onDevelopmentDTO.getDLGDateNom();
        if (dateNom != null) {
    ...
    public static TBIOnDevelopment convertDatabaseObjectToDTO(DevelopmentPAR development) {
